...
gcloud builds submit \
  ...
  --substitutions=_UCD_LIB_INITIATOR=$USER,REPO_NAME=$REPO_NAME,BRANCH_NAME=$BRANCH_NAME,_APP_IMAGE_NAME_TAG=$APP_IMAGE_NAME_TAG,_APP_UTILS_IMAGE_NAME_TAG=$APP_UTILS_IMAGE_NAME_TAG,_CONFIG_PROJECT=$APP_SLUG \
  .
